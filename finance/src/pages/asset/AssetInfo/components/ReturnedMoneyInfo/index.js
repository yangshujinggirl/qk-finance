    ...
    return <>
        <SubTitleMod title="付款方式1">
            <YtBaseInfo colSpan={12} dataInfo={[
                {key: '付款方式', value: info.paymentType},
                {key: '付款账户名', value: info.paymentAccountName},
                {key: '付款金额（元）', value: info.paymentAmount},
                {key: '付款时间', value: paymentTime},
                {key: '付款账号', value: paymentAccount},
                {key: '付款开户行', value: paymentBankName},
                {key: '收款账户名', value: receiptAccountName},
                {key: '收款开户行', value: receiptBankName},
                {key: '流水号', value: serialNumber},
                {key: '回款凭证', value: <YtenlargeImg url={moneyBackUrl}/>},
            ]}/>
        </SubTitleMod>
